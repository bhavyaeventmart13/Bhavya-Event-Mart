...
const AddPopup = ({ isOpen, onClose }) => {
  ...
  const fetchPopups = async () => {
    try {
      const res = await fetch("https://pankaj-cloth-webapp.onrender.com/api/popups");
  ...
  const handleDelete = async (id) => {
    ...
    try {
      const res = await fetch(`https://pankaj-cloth-webapp.onrender.com/api/popups/${id}`, { method: "DELETE" });
